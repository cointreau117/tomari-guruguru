...
ぐるぐる版とトーク版は1つのアプリに統合済み。マイク／音声ファイルの音量解析の配線は残してありますが、口パク出力は無効化しており、今後「音楽に反応して踊る／演出する」方向へ改造していく土台になります。
...
4. **マイク開始** または音声ファイル読み込みで音量メーターが反応します（音声解析の配線確認用。口パク出力は現状無効）
